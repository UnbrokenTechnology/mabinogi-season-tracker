...
export const HELP: Record<string, HelpTopic> = {
  ...
  ratioPlan: {
    title: 'The true-ratio math',
    text: "This one solves the ACTUAL production problem: split your fields between the 3 field crops, run recipes only as fast as your own plots supply their ingredients (real ratios — a Twilight Lute needs 2 Red Pears + 1 Jasmine + 1 Blackberry), respect each cauldron's 60 minutes per hour, and sell whatever's left over raw. It tries every field split and picks the most gold per active hour.\n\nUnlike the Max Profit Planner (which prices ingredients at the AH and can count one recipe's margin twice), this number is achievable end-to-end with zero buying — so it's the honest whole-farm figure.\n\nAssumes: continuous rates (fractional fields = alternate what you plant there), base craft times, ×1 yield, no Bounty or energy, and that everything sells at your entered prices."
  },
  farmPlanner: {
